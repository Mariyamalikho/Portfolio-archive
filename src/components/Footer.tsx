      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div className="border-l border-purple-500/30 pl-6">
              ...
              <p className="text-white/50 text-sm leading-relaxed">
                Thesis and final-year project on "Personal Finance Tracker".
                Designed and developed a web-based application that empowers
                users to manage their income, expenses, and financial trends
                with ease.
              </p>
            </div>
          </div>
        ...
        >
          ...
          <p className="text-white/50 text-lg max-w-md leading-relaxed">
            Currently based in Pakistan, but open to relocation. Always
            interested in discussing digital innovation, IT systems, and visual
            communication.
          </p>
        </motion.div>
      </div>
