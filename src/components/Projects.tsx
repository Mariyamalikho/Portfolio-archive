...
const PROJECTS = [
  {
    ...
    description:
      "Web application empowering users to manage income, expenses, and trends.",
    year: "2025",
  ...
  },
  {
    ...
    description:
      "Structured digital assets improving internal knowledge accessibility for global teams.",
    year: "2026",
  ...
  },
  {
    ...
    description:
      "Generated OEE reports and digitized inspection findings to optimize production.",
    year: "2024",
  ...
  },
  {
    ...
    description:
      "Translated complex narratives into clear visual storytelling and animated creatives.",
    year: "2023",
...
export function Projects() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full py-32 px-6 md:px-12 lg:px-24 text-white overflow-hidden"
    >
      ...
      >
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 30%, rgba(120, 80, 255, 1), rgba(34, 211, 238, 0.5), transparent 70%)",
