            ...
            >
              <div className="md:grid md:grid-cols-4 md:gap-8 items-start">
                ...
                <div className="md:col-span-1 mb-4 md:mb-0 md:text-right relative z-20 md:pr-8">
                  <p className="text-sm text-white/50 font-medium uppercase tracking-wider group-hover:text-purple-400 transition-colors">
                    {exp.date}
                  </p>
                ...
                <div className="md:col-span-3 relative md:pl-12 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <div className="p-6 rounded-2xl border border-transparent transition-all duration-300 group-hover:bg-white/[0.02] group-hover:border-white/10 group-hover:shadow-[0_0_30px_-10px_rgba(168,85,247,0.1)] -mt-6">
                    <h3 className="text-2xl font-semibold mb-1 text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-300 group-hover:to-pink-300 transition-all duration-300">
                      {exp.role}
                    </h3>
                    <p className="text-lg text-purple-400/80 font-medium mb-4">
                      {exp.company}
                    </p>
                    <ul className="space-y-2">
                      {exp.details.map((detail, idx) => (
                        <li
                          key={idx}
                          className="text-white/60 text-base leading-relaxed flex items-start group-hover:text-white/80 transition-colors"
                        >
